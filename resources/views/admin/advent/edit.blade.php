...
@section('title','广告修改')
@section('content')
<form class="layui-form" action="{{url('admin/advent/update')}}" method="post" enctype="multipart/form-data">
<input type="hidden" value="{{$info->f_id}}" name="f_id">
        ...
        <div class="layui-form-item layui-col-md5">
            ...
            <div class="layui-input-block">
                <input type="text" name="f_url" value="{{$info->f_url}}" required  lay-verify="required" placeholder="请输入地址" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <div>&nbsp;</div>
                <img src="{{$info->f_img}}" width="150px">
            </div>
        </div>
        <div class="layui-form-item layui-form-text layui-col-md7">
            <label class="layui-form-label">广告简述</label>
            <div class="layui-input-block">
                <textarea name="f_desc" placeholder="请输入内容" class="layui-textarea">{{$info->f_desc}}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
